...
---@type table<OmpCommandLifecycleStage, { id: string, fn: OmpCommandDispatchHook, command_filter: table<string, true>|nil }[]>
local hook_registry = {
  before = {},
  after = {},
  error = {},
...
---@alias OmpCommandHookEntry { id: string, fn: OmpCommandDispatchHook, command_filter: table<string, true>|nil }
...
---@param entry { id: string, fn: OmpCommandDispatchHook, command_filter: table<string, true>|nil }
---@param ctx OmpCommandDispatchContext
---@return boolean
...
---@param stage OmpCommandLifecycleStage
---@param hook_id string
---@param hook_fn OmpCommandDispatchHook
---@param ctx OmpCommandDispatchContext
---@return OmpCommandDispatchContext
...
---@return OmpCommandDispatchError
...
---@param ctx OmpCommandActionContext
---@return OmpCommandDispatchResult
function M.execute(ctx)
  ---@type OmpCommandDispatchContext
  local dispatch_ctx = {
    parsed = ctx.parsed,
