local base_context = require('omp.context.base_context')
...
---@param left OmpContextSelection|nil
---@param right OmpContextSelection|nil
---@return boolean
...
---@param selection OmpContextSelection
---@return OmpMessagePart
...
---@param diagnostics OmpDiagnostic[]
...
---@param selections? OmpContextSelection[]
...
---@param buf integer
---@param context_config? OmpContextConfig
---@param range? { start_line: integer, end_line: integer }
---@return OmpDiagnostic[]|nil
...
---@param opts? { range?: { start: integer, stop: integer }, context_config?: OmpContextConfig }
