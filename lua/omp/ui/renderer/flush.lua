...
local function warn_part_render_error_once(part_id, message_id, err)
  ...
  vim.schedule(function()
    ...
    notify('[omp.nvim] ' .. msg, vim.log.levels.WARN)
  end)
end
...
local function do_trigger_on_data_rendered()
  ...
  vim.b[output_buf].omp_markdown_namespace = output_window.markdown_namespace
...
M.trigger_on_data_rendered =
  require('omp.util').debounce(do_trigger_on_data_rendered, config.ui.output.rendering.markdown_debounce_ms or 250)
