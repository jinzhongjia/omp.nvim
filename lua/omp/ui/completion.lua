...
function M.setup()
  local files_source = require('omp.ui.completion.files')
  local subagents_source = require('omp.ui.completion.subagents')
  local commands_source = require('omp.ui.completion.commands')
  local context_source = require('omp.ui.completion.context')
  local skills_source = require('omp.ui.completion.skills')
