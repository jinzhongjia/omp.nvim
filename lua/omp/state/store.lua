...
---@class OmpStateData
---@field windows OmpWindowState|nil
---@field is_opening boolean
---@field input_content table
---@field is_omp_focused boolean
---@field last_focused_omp_window string|nil
---@field last_input_window_position integer[]|nil
---@field last_output_window_position integer[]|nil
---@field last_code_win_before_omp integer|nil
...
---@field rpc_manager OmpApiClient|nil
...
---@field omp_cli_version Promise<string>|nil
---@field current_cwd string|nil
---@field session_locked boolean|nil
---@field _hidden_buffers OmpHiddenBuffers|nil
...
local _state = {
  ...
  is_opening = false,
  input_content = {},
  is_omp_focused = false,
  last_focused_omp_window = nil,
  last_input_window_position = nil,
  last_output_window_position = nil,
  last_code_win_before_omp = nil,
...
---@generic K extends keyof OmpStateData
---@param key K
---@param new_val std.RawGet<OmpStateData, K>
---@param old_val std.RawGet<OmpStateData, K>
...
---@generic K extends keyof OmpStateData
---@param key K
---@return std.RawGet<OmpStateData, K>
function M.get(key)
  return _state[key]
end
...
---@generic K extends keyof OmpStateData
---@param key K
---@param value std.RawGet<OmpStateData, K>
---@return std.RawGet<OmpStateData, K>
...
---@generic K extends keyof OmpStateData
---@param key K
---@param updater fun(current: std.RawGet<OmpStateData, K>): std.RawGet<OmpStateData, K>
---@return std.RawGet<OmpStateData, K>
...
---@param callback fun(store: OmpStateStore)
...
---@generic K extends keyof OmpStateData
---@param key K
---@param mutator fun(current: std.RawGet<OmpStateData, K>):nil
---@return std.RawGet<OmpStateData, K>
function M.mutate(key, mutator)
  if _state[key] == nil then
    _state[key] = {} --[[@as std.RawGet<OmpStateData, K>]]
  end
...
---@generic K extends keyof OmpStateData
---@param key K|K[]|nil
---@param cb fun(key:K, new_val:std.RawGet<OmpStateData, K>, old_val:std.RawGet<OmpStateData, K>)
...
---@generic K extends keyof OmpStateData
---@param key K
---@param value std.RawGet<OmpStateData, K> extends any[] and std.RawGet<OmpStateData, K>[integer] or never
