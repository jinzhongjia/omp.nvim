-- Default and user-provided settings for omp.nvim

---@type OmpConfigModule
...
M.defaults = {
  ...
  keymap = {
    editor = {
      ['<leader>og'] =  { 'toggle',                                            desc = 'Toggle Omp window' },
      ...
      ['<leader>oq'] =  { 'close',                                             desc = 'Close Omp window' },
    ...
    output_window = {
      ['<esc>'] =       { 'close',                                             desc = 'Close Omp windows' },
    ...
    input_window = {
      ...
      ['<esc>']  =      { 'close',                                             desc = 'Close Omp windows',       defer_to_completion = true },
  ...
  ui = {
    ...
    display_cost = true,
    window_highlight = 'Normal:OmpBackground,FloatBorder:OmpBorder',
    persist_state = true,
    icons = {
      preset = 'nerdfonts',
      overrides = {},
...
--- @param opts OmpConfig
function M.setup(opts)
  opts = opts or {}

  M.values = vim.tbl_deep_extend('force', M.values, opts --[[@as OmpConfig]])
